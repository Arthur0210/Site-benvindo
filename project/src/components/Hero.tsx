        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              O melhoramento genético animal consiste em um conjunto de técnicas voltadas ao aperfeiçoamento de características desejáveis nos animais, como a produção de leite, carne e ovos, além da resistência a doenças e da capacidade de adaptação ao ambiente.
            </p>

            <p className="text-lg text-gray-600 mb-12 leading-relaxed">
              Desde os primeiros cruzamentos seletivos até as atuais aplicações da biotecnologia e da análise de DNA, o principal objetivo dessa prática é aumentar a produtividade e aprimorar a qualidade dos rebanhos, preservando, ao mesmo tempo, a diversidade genética das espécies.
            </p>
