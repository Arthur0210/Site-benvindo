        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-100">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              O melhoramento genético é um dos principais responsáveis pelo aumento da produtividade na pecuária. Estudos indicam que entre 60% e 80% dos ganhos obtidos nas últimas décadas resultam diretamente da seleção genética.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Estima-se que, para cada real investido em programas de melhoramento, o retorno econômico varie de 10 a 15 reais ao longo do tempo, devido ao efeito cumulativo transmitido entre gerações.
            </p>
          </div>
