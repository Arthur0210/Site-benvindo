      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-8 border border-emerald-100">
          ...
          <p className="text-gray-700 leading-relaxed">
            O melhoramento genético moderno não se restringe a uma única técnica. Os resultados mais expressivos são alcançados quando há integração entre os métodos tradicionais e as biotecnologias. A seleção genômica, por exemplo, possibilita identificar os animais mais promissores ainda nas fases iniciais de desenvolvimento, que posteriormente podem ser multiplicados por meio da transferência de embriões e da inseminação artificial, acelerando o avanço genético do rebanho.
          </p>
        </div>
      </div>
    </div>
